...
const RotatingBrain = memo(function RotatingBrain() {
  return (
    <motion.div
      animate={{ rotate: 360 }}
...
const SectionHeading = memo(function SectionHeading({ title, gradient = true }: { title: string, gradient?: boolean }) {
  return (
...
const TechBadge = memo(function TechBadge({ tech }: { tech: { name: string, level: string, category: string } }) {
  return (
    <Badge 
      className={`
