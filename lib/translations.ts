...
// Define proper translation function type
export type TranslationValue = string | Project[] | Reference[] | Record<string, unknown>;
export type TranslationFunction = (key: string) => TranslationValue;
